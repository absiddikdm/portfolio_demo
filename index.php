...
$after_assoc_about=  mysqli_fetch_assoc($select_about_res);
 ...
 $select_expertise_res= mysqli_query($db_connect,$select_expertise);
  ...
  $select_service_res= mysqli_query($db_connect,$select_services);
...
<head>
  ...
  <title>absiddikdm freelancer portfolio site</title>
...
<nav class="navbar navbar-expand-lg bg-transprent py-4 fixed-top navigation" id="navbar">
	<div class="container">
	  <a class="navbar-brand" href="index.html">
	  	<img width="100" src="uploads/logo/<?=$after_assoc_logo['header_logo']?>" alt="">
	  </a>
		...
		<div class="row align-items-center">
			<div class="col-lg-5 col-sm-12 col-12 col-md-5">
				<div class="slider-img position-relative">
					<img src="uploads//about/<?=$after_assoc_about['image']?>" alt=""
			...
			<div class="col-lg-6 col-12 col-md-7">
				<div class="ml-5 position-relative mt-5 mt-lg-0">
					<span class="head-trans"><?=$after_assoc_about['nic_name']?></span>
					<h1 class="font-weight-normal text-color text-md"><i class="ti-minus mr-2">

					</i><?=$after_assoc_about['designation']?></h1>
		...
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="section-title text-center">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"><i class="ti-minus mr-2"></i>SET Skills</span>
					<h2 class="title">Expertise</h2>
				</div>
			</div>
		</div>
		<div class="row">
			<?php foreach ($select_expertise_res as $skil){ ?>
			<div class="col-lg-6 col-md-6">
				<div class="skill-bar mb-4 mb-lg-0">
					<div class="mb-4 text-right"><h4 class="font-weight-normal"> <?= $skil['topic_name']?> </h4></div>
					<div class="progress">
						<div class="progress-bar" data-percent="<?= $skil['percentage']?>">
							<span class="percent-text"><span class="count"><?= $skil['percentage']?></span>%</span>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="post_gallery owl-carousel owl-theme">
				<?php foreach($select_port_res as $portfolio){ ?>
				<div class="item">
...
<section class="section" id="contact" data-aos="fade-up">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-lg-8">
					<form class="contact__form form-row contact-form" method="post" action="message.php" id="contactForm">
					 <div class="row">
                        <div class="col-12">
...
<footer class="footer border-top-1">
	<div class="container">
		<div class="row align-items-center text-center text-lg-left">
			<div class="col-lg-2">
			<img width="100" src="uploads/logo/<?=$after_assoc_logo['footer_logo']?>" alt="">
			</div>
			<div class="col-lg-10">
